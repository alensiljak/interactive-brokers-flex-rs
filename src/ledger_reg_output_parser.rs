...
/// Parses regular Ledger syntax, which can be generated by the Print command.
pub fn get_rows_from_print(lines: Vec<&str>) -> Vec<CommonTransaction> {
    todo!("use a real Ledger parser here")
}
...
mod tests {
    ...
    use super::{get_row_from_register_line, get_rows_from_print};
    ...
    fn parse_print() {
        ...
        let actual = get_rows_from_print(lines);
